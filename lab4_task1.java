//Данная программа выполняет «сглаживание» вещественного массива A размерности N следующим образом:
//элемент A с K-тым индексом заменяется на среднее арифметическое первых K исходных элементов массива A.
//На экран выводятся как оригинальное состояние массива, так и итоговое.
